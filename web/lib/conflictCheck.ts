...
// horario contra /api/calendar/free-slots (ya existe, ver Fase 8 del plan) —
// nunca mueve nada automáticamente, solo ofrece horarios libres cercanos para
// que el usuario decida. Lógica pura, sin red — ver
// web/scripts/verify-conflict-check.mjs. Espejo: mobile/src/lib/conflictCheck.ts
// (mantener ambas copias idénticas si una cambia).

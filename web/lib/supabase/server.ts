      ...
      cookies: {
        ...
        setAll(cookiesToSet) {
          try {
            ...
            // La sesión se refresca igualmente vía middleware.
          }
        },
      },
    }
...
/**
 * Cliente con la service_role key. Solo para uso en el servidor (saga,
 * webhooks, callbacks OAuth) ya que ignora RLS por completo.
 */

...
// pura, sin red ni DB. ESPEJO de web/lib/productivityReport.ts — mantener
// ambas copias idénticas si una cambia (probado allá con
// web/scripts/verify-productivity-report.mjs).

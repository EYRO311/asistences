...
// Equivalente mobile de web/lib/dailyMarkdown.ts. Genera el checklist en
// markdown de las tareas de hoy para pegar en una nota diaria de Obsidian.
// Solo título, hora y categorías (como tags) — sin descripción/ubicación,
// que van encriptadas y no aportan aquí.
